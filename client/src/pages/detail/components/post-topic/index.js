        ...
        <section key={1} className="input-url">
          {this.state.showInputNotice ? (
            ...
            <div className="input-container">
              <span className="close-circle" onClick={this.closeInputUrl} />
              <input
                type="text"
      ...
      return (
        <section key={2} className="input-url">
          <div className="notice">
            ...
            <span>
              {/* <Upload
                successCb={this.uploadImgSuccess}
      ...
      <div className={`${Style["post-topic"]}`}>
        <section className="topic-content">
          ...
          <div className="descript">
            <textarea
              value={this.state.topicDescript}
              onChange={this.handelChangeTextArea}
              rows="4"
              cols="50"
          ...
          <footer className="footer">
            ...
            <span className="post" onClick={this.postTopic}>
              发帖
            </span>
          </footer>
        </section>
